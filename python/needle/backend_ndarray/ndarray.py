...
class NDArray:
    ...
    def reshape(self, new_shape):
        ...
        ### BEGIN YOUR SOLUTION
        assert prod(self.shape) == prod(new_shape), "Product of current shape is not equal to the product of the new shape"
        assert self.is_compact(), "Matrix is not compact"
